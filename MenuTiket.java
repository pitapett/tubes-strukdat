...
class TiketAktifLinkedList {
    ...
    public void deleteTicket(int kodeBooking) {
    ...
    public void moveTicket(TiketHistoryLinkedList historyList, int kodeBooking) { // kan mau move dari aktif -> history, makanya history hrs ada di parameter
